...
## Environments
- Preview: https://main--studyspace--aemysites.aem.page/
- Live: https://main--studyspace--aemysites.aem.live/
- Block Library: https://main--studyspace--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `studyspace` directory in your favorite IDE and start coding :)
